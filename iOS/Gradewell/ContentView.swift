...
struct ContentView: View {
    ...
    @State private var editingItem: GradewellItem?
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            ...
            Text("Tap + to add your first grade.")
                .font(Theme.captionFont)
                .foregroundStyle(Theme.textSecondary)
        }
    }

    private func row(for item: GradewellItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: GradewellItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
